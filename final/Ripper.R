...
set.seed(05713)
  ...
  modelJRip <- JRip(genres.1~., train_data[,c("cast.1","director.1","genres.1","genres.2","genres.3","genres.4","producer.1","writer.1")])
  




  predictions <- predict(modelJRip, test_data[,c("cast.1","director.1","genres.1","genres.2","genres.3","genres.4","producer.1","writer.1")])
